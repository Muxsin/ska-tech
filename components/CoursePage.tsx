...
const courseData: Record<string, any> = {
  ...
  tj: {
    "html-css": {
      ...
      level: "Нав омӯз",
      title: "HTML ва CSS",
      subtitle: "Асосҳои бунёдии меъмории веби муосир.",
      ...
      modules: [
        { title: "Модули 1: Асосҳои HTML", items: ["Сохтори ҳуҷҷати HTML", "Тегҳо ва атрибутҳо", "Нишонагузории семантикӣ (Semantic markup)", "Формаҳо ва вуруди маълумот", "Мета тегҳо ва асосҳои SEO"] },
        { title: "Модули 2: Асосҳои CSS", items: ["Селекторҳо ва мушаххасот", "Модели қуттӣ (Box model) ва ҷойгиршавӣ", "Тарҳҳои Flexbox ва Grid", "Тарҳи адаптивӣ ва мобилӣ", "Тағйирёбандаҳои CSS"] },
        { title: "Модули 3: Таҷриба ва Лоиҳа", items: ["Сохтани саҳифаи фуруд (landing page)", "Тарҳрезӣ аз рӯи дизайни Figma", "Мутобиқсозии мобилӣ", "Оптимизатсия ва иҷроиш", "Истиқрори лоиҳа дар сервер"] }
      ],
      targetAudience: [
        { icon: <Terminal className="w-5 h-5" />, color: "text-blue-500", bg: "bg-blue-500/10", title: "Нав омӯзони IT", desc: "Онҳое, ки мехоҳанд карераро дар таҳияи веб оғоз кунанд, аммо намедонанд аз куҷо оғоз намоянд." },
        { icon: <Layout className="w-5 h-5" />, color: "text-pink-500", bg: "bg-pink-500/10", title: "Дизайнерҳо", desc: "Фаҳмидани маҳдудиятҳои техникӣ барои беҳтар кардани муошират бо таҳиягарон ва эҷоди маҳсулоти беҳтар." }
      ]
    },
    "javascript": {
      category: "Frontend",
      ...
      level: "Нав омӯз",
      title: "JavaScript",
      subtitle: "Забони барномасозии веби муосир.",
      description: "Аз сифр то мутахассис дар JS. ES6+, барномасозии асинхронӣ ва идоракунии DOM-ро барои сохтани барномаҳои динамикӣ омӯзед.",
      price: "6 499 ₽",
      oldPrice: "10 000 ₽",
      schedule: "3 бор / ҳафта",
      modules: [
        { title: "Модули 1: Асосҳои JS", items: ["Тағйирёбандаҳо ва Намудҳои маълумот", "Идоракунии ҷараён (Control Flow)", "Функсияҳо ва доираи амал", "Массивҳо ва Объектҳо"] },
        { title: "Модули 2: DOM ва ҳодисаҳо", items: ["Интихоби элементҳо", "Идоракунии ҳодисаҳо (Event Listeners)", "Тағйири динамикии DOM", "Санҷиши формаҳо"] },
        { title: "Модули 3: JS-и пешрафта", items: ["Имкониятҳои ES6+", "Promises ва Async/Await", "Кор бо API (Fetch)", "Local Storage ва Session Storage"] }
      ],
      targetAudience: [
        { icon: <Code className="w-5 h-5" />, color: "text-amber-500", bg: "bg-amber-500/10", title: "Донишҷӯён", desc: "Донишҷӯёни факултетҳои техникӣ, ки мехоҳанд малакаҳои амалӣ дошта бошанд." }
      ]
    },
    "react": {
      category: "Frontend",
      ...
      level: "Миёна",
      title: "React.js",
      subtitle: "Сохтани интерфейсҳои корбарии муосир.",
      description: "Машҳуртарин китобхонаи UI. Компонентҳо, хукҳо (hooks), идоракунии ҳолат (state management) ва сохтани SPA.",
      price: "7 999 ₽",
      oldPrice: "12 000 ₽",
      schedule: "2 бор / ҳафта",
      modules: [
        { title: "Модули 1: Асосҳои React", items: ["Компонентҳо ва Props", "State ва Lifecycle", "Идоракунии ҳодисаҳо", "Render-и шартӣ"] },
        { title: "Модули 2: Hooks", items: ["useState ва useEffect", "Custom Hooks", "useContext", "useReducer"] },
        { title: "Модули 3: Экосистема", items: ["React Router", "Идоракунии ҳолат (Redux/Zustand)", "Интегратсия бо API", "Муқаддима ба Next.js"] }
      ],
      targetAudience: [
        { icon: <Layers className="w-5 h-5" />, color: "text-cyan-500", bg: "bg-cyan-500/10", title: "Барномасозони JS", desc: "Барои таҳиягароне, ки мехоҳанд дар фреймворкҳои муосири фронтенд тахассус пайдо кунанд." }
      ]
    },
    "kids-coding": {
      ...
      subtitle: "Мантиқ, эҷодиёт ва сохтани бозиҳо.",
      description: "Муқаддимаи шавқовар ба ҷаҳони IT. Мо забонҳои визуалиро ба мисли Scratch истифода мебарем ва сипас ба Python мегузарем.",
      price: "3 999 ₽/моҳ",
      oldPrice: "5 000 ₽/моҳ",
      schedule: "2 бор / ҳафта",
      modules: [
        { title: "Модули 1: Мантиқи Визуалӣ (Scratch)", items: ["Интерфейси Scratch", "Сиклҳо ва шартҳо", "Асосҳои аниматсия", "Овоз ва интерактив"] },
        { title: "Модули 2: Тарроҳии Бозӣ", items: ["Тарроҳии қаҳрамонҳо", "Сохтани сатҳҳо", "Системаи холҳо", "Намоиши лоиҳаҳо"] },
        { title: "Модули 3: Муқаддима ба Python", items: ["Синтаксиси асосӣ", "Тағйирёбандаҳо", "Бозиҳои матнӣ", "Сохтани ҳисобкунак"] }
      ],
      targetAudience: [
        { icon: <Baby className="w-5 h-5" />, color: "text-green-500", bg: "bg-green-500/10", title: "Наврасон", desc: "Кӯдакони 8-14 сола, ки ба технология ва компютер шавқ доранд." }
      ]
    },
    "golang": {
      category: "Backend",
      ...
      level: "Пешрафта",
      title: "Golang",
      subtitle: "Системаҳои бэкенди баландсифат.",
      description: "Go-ро барои сохтани хидматҳои миқёспазир аз худ кунед. Ҳамзамонӣ (concurrency), меъмории микросервисҳо ва истиқрори абрӣ.",
      price: "9 999 ₽",
      oldPrice: "15 000 ₽",
      schedule: "2 бор / ҳафта",
      modules: [
        { title: "Модули 1: Синтаксиси Go", items: ["Типҳо ва Тағйирёбандаҳо", "Структураҳо ва Интерфейсҳо", "Пакетҳо", "Идоракунии хатогиҳо"] },
        { title: "Модули 2: Ҳамзамонӣ (Concurrency)", items: ["Goroutines", "Channels", "Select Statement", "Sync Package"] },
        { title: "Модули 3: Хидматҳои Веб", items: ["HTTP Server", "REST API", "Пайвастшавӣ ба пойгоҳи додаҳо", "Микросервисҳо"] }
      ],
      targetAudience: [
        { icon: <Server className="w-5 h-5" />, color: "text-blue-500", bg: "bg-blue-500/10", title: "Бэкенд таҳиягарон", desc: "Барои онҳое, ки мехоҳанд системаҳои сарбории баланд (High-load) созанд." }
      ]
    },
    "cpp-basics": {
      category: "Асосӣ",
      ...
      level: "Нав омӯз",
      title: "Асосҳои C++",
      subtitle: "Ғуттаи амиқ ба хотира ва алгоритмҳо.",
      description: "Компютер чӣ гуна кор мекунад? Идоракунии хотира, нишондиҳандаҳо (pointers) ва барномасозии объектӣ-гаро (OOP)-ро омӯзед.",
      price: "5 999 ₽",
      oldPrice: "9 000 ₽",
      schedule: "2 бор / ҳафта",
      modules: [
        { title: "Модули 1: Синтаксис", items: ["Тағйирёбандаҳо ва Типҳо", "Сиклҳо ва Мантиқ", "Функсияҳо", "Массивы"] },
        { title: "Модули 2: Хотира", items: ["Pointers (Нишондиҳандаҳо)", "References", "Dynamic Memory", "Stack vs Heap"] },
        { title: "Модули 3: OOP", items: ["Classes", "Inheritance", "Polymorphism", "Templates"] }
      ],
      targetAudience: [
        { icon: <Cpu className="w-5 h-5" />, color: "text-red-500", bg: "bg-red-500/10", title: "Донишҷӯён", desc: "Донишҷӯёни донишгоҳҳо, ки ба заминаи қавии алгоритмӣ ниёз доранд." }
      ]
    }
  }
};
...
const CoursePage: React.FC = () => {
  ...
  // Fallback to English if translation is missing for a specific course ID
    ...
    <div className="pt-20 min-h-screen bg-white dark:bg-black transition-colors duration-300">
      ...
      <section className="relative pt-20 pb-20 overflow-hidden">
        ...
        <div className="absolute inset-0 pointer-events-none">
          ...
          <div className="absolute top-0 right-0 w-[600px] h-[600px] bg-brand/10 rounded-full blur-[80px] pointer-events-none opacity-50 mix-blend-multiply dark:mix-blend-screen"></div>
        </div>
        ...
        <div className="max-w-7xl mx-auto px-6 relative z-10">
          ...
          <div className="flex flex-col lg:flex-row gap-16 items-start">
            ...
            <div className="w-full lg:w-[400px] lg:sticky lg:top-28 space-y-8">
              ...
              {/* Pricing Card */}
              <div className="p-8 rounded-3xl bg-slate-900 dark:bg-zinc-900 text-white shadow-2xl shadow-brand/5 ring-1 ring-white/10 relative overflow-hidden transform-gpu">
